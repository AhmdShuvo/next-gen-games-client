    ...
    <div>
      ...
      <div className="flex min-h-screen bg-white">
        ...
        <div className="md:w-1/2 max-w-lg mx-auto my-24 px-4 py-5 shadow-none">
          ...
          <form action="" onSubmit={handleSignup} className="p-0">
            <div className="mt-5">
              {/* <label for="email" className="sc-bqyKva ePvcBv">Email</label> */}
              <input type="email" onChange={handleChange} name='email' required className="block w-full p-2 border rounded border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-transparent " placeholder="Email" />
            </div>
            <div className="mt-5">
              <input type="text" onChange={handleChange} name='username' required className="block w-full p-2 border rounded border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-transparent " placeholder="User-name" />
            </div>
            <div className="mt-5">
              <input type="password" onChange={handleChange} name="password" required className="block w-full p-2 border rounded border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-transparent  " placeholder="Password" />
            </div>
            <div className="mt-6 block p-5 text-sm md:font-sans text-xs text-gray-800">
              <input type="checkbox" className="inline-block border-0  " required />
